...
export default function SkillAssessmentTest({ navigation, route }) {
  ...
  const initializeTest = async () => {
    try {
      ...
      // Use mock questions instead of calling Firebase function
      const mockQuestions = [
        {
          id: '1',
          category: 'math',
        ...
        },
        {
          id: '4',
          category: 'memory',
          question: 'Remember this sequence: Apple, Book, Cat. What was the second item?',
